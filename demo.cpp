...
private:
    ...
    void handle_write(const std::error_code& error)
    {
        ...
        if (!error)
        {
            ...
            heartbeat_timer_.async_wait(std::bind(&client::repeat_handle_write, this, _1));
        }
        else
        {
...
//
//        client c(io_context);
//        c.start(r.resolve("127.0.0.1", "8898"));
//
//        client c2(io_context);
//        c2.start(r.resolve("127.0.0.1", "8898"));
//
//        client c3(io_context);
//        c3.start(r.resolve("127.0.0.1", "8898"));
//
//        client c4(io_context);
//        c4.start(r.resolve("127.0.0.1", "8898"));
//
//        client c5(io_context);
//        c5.start(r.resolve("127.0.0.1", "8897"));
//
//        io_context.run();
//    }
